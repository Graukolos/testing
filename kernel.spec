...
%define pkgrelease 450.asahi
%define kversion 6
%define tarfile_release 6.3.6
# This is needed to do merge window version magic
%define patchlevel 3
# This allows pkg_release to have configurable %%{?dist} tag
%define specrelease 450.asahi%{?buildid}%{?dist}
...
#
%changelog
* Wed Jun 07 2023 Neal Gompa <neal@gompa.dev> [6.3.6-450.asahi]
- redhat: Tweak spec to do a verbose build (Neal Gompa)
- redhat/configs: aarch64: Change CONFIG_APPLE_MBOX to =y (Neal Gompa)
...
- scripts: new terminology in modern bindgen (Eric Curtin)
- redhat/configs: Enable DRM_GEM_SHMEM_HELPER (Neal Gompa)
- redhat: Turn on support for Rust code (Neal Gompa)

* Wed Jun 07 2023 Neal Gompa <neal@gompa.dev> [6.3.6-400.asahi]
- redhat: Enable kernel-headers build (Neal Gompa)
- redhat/configs: aarch64: Enable ARM64_MEMORY_MODEL_CONTROL (Neal Gompa)
- redhat/configs: Switch AArch64 to 16K pages (Neal Gompa)
- redhat/configs: s390x: Drop CONFIG_BACKLIGHT_CLASS_DEVICE=m for Fedora (Neal Gompa)
- redhat/configs: aarch64: asahi: Swap to new APPLE_MBOX driver (Neal Gompa)
...
- PCI: apple: Do not power down devices on port setup (Hector Martin)
- fixup! xhci-pci: asmedia: Add a firmware loader for ASM2214a chips (Hector Martin)
- cpufreq: apple-soc: Drop setting the PS2 field on M2+ (Hector Martin)
...
- fixup! arm64: dts: apple: t8112: Add mtp device nodes for j413/j493 (Hector Martin)
- fixup! arm64: dts: apple: Add MTP nodes to t6020x (Hector Martin)
- drivers/perf: apple_m1: Force 63bit counters for M2 CPUs (Marc Zyngier)
- rust: sync: arc: Add lockdep integration (Asahi Lina)
- rust: sync: Add LockdepMap abstraction (Asahi Lina)
- drm/asahi: New Mutex style (Asahi Lina)
- drm/asahi: Classless mutex etc (Asahi Lina)
- fixup! rust: drm: mm: Add DRM MM Range Allocator abstraction (Asahi Lina)
- fixup! *RFL import: The rest of kernel::device (minus clk stuff) (Asahi Lina)
- rust: init: Update documentation for new mutex init style (Asahi Lina)
- rust: sync: Classless Lock::new() and pin_init() (Asahi Lina)
- rust: sync: Implement dynamic lockdep class creation (Asahi Lina)
- drm/asahi: Lock class fixups (Asahi Lina)
- fixup! rust: drm: mm: Add DRM MM Range Allocator abstraction (Asahi Lina)
- fixup! rust: dma_fence: Add DMA Fence abstraction (Asahi Lina)
- fixup! *RFL import: The rest of kernel::device (minus clk stuff) (Asahi Lina)
- rust: sync: Replace static LockClassKey refs with a pointer wrapper (Asahi Lina)
- rust: sync: Add dummy LockClassKey implementation for !CONFIG_LOCKDEP (Asahi Lina)
- rust: kernel: Add simple siphash abstraction (Asahi Lina)
- rust: Use absolute paths to build Rust objects (Asahi Lina)
- rust: types: Add Opaque::zeroed() (Asahi Lina)
- rust: kernel: str: Implement Debug for CString (Asahi Lina)
- drm/asahi: Convert to ARef<Device<T>> DRM device API (Asahi Lina)
- rust: drm: device: Convert Device to AlwaysRefCounted (Asahi Lina)
- drm/asahi: Delete place module (Asahi Lina)
- drm/asahi: initdata: Port to init!() (Asahi Lina)
- rust: init: Add chain() and pin_chain() functions (Asahi Lina)
- drm/asahi: object,alloc: Drop new_prealloc() (Asahi Lina)
- drm/asahi: queue::render: Port to init!() (Asahi Lina)
- rust: macros: versions: Make <foo> parsing stricter (Asahi Lina)
- drm/asahi: queue::compute: Port to init!() (Asahi Lina)
- drm/asahi: queue::mod: Port to init!() (Asahi Lina)
- drm/asahi: workqueue: Port to init!() (Asahi Lina)
- drm/asahi: buffer: Replace place!() with init!() (Asahi Lina)
- drm/asahi: Add support for initializing GpuObjects with init!() (Asahi Lina)
- rust: init: Support type paths in pin_init!() and friends (Asahi Lina)
- drm/asahi: mmu: Switch to pin_init_array_from_fn (Asahi Lina)
- drm/asahi: Switch to the kernel crate Zeroable trait (Asahi Lina)
- rust: init: Implement Zeroable::zeroed() (Asahi Lina)
- rust: init: Add functions to create array initializers (Benno Lossin)
- rust: init: add `..Zeroable::zeroed()` syntax for zeroing all missing fields (Benno Lossin)
- rust: init: wrap type checking struct initializers in a closure (Benno Lossin)
- rust: init: make guards in the init macros hygienic (Benno Lossin)
- rust: add derive macro for `Zeroable` (Benno Lossin)
- rust: init: update macro expansion example in docs (Benno Lossin)
- rust: macros: replace Self with the concrete type in #[pin_data] (Benno Lossin)
- rust: macros: refactor generics parsing of `#[pin_data]` into its own function (Benno Lossin)
- rust: macros: fix usage of `#[allow]` in `quote!` (Benno Lossin)
- drm/asahi: Make GpuManager pinned (Asahi Lina)
- drm/asahi: Update for new upstream APIs (Asahi Lina)
- rust: drm: gem: Allow pinning GEM object driver data (Asahi Lina)
- rust: kernel: lock: Add Lock::pin_init() (Asahi Lina)
- rust: Enable type_alias_impl_trait (Asahi Lina)
- drm/asahi: render: Implement unknown value UAPI extension (Asahi Lina)
- DO NOT MERGE: drm/asahi: Add an experimental UAPI extension (Asahi Lina)
- drm/asahi: render: Update for new UAPI (Asahi Lina)
- drm/asahi: render: Misc value updates for G14X/V13_3 (Asahi Lina)
- drm/asahi: buffer: Calculate cluster sizes using config data (Asahi Lina)
- drm/asahi: hw: Put clustering sizes into the HwConfig struct (Asahi Lina)
- drm/asahi: gpu,mmu: Fix MMIO maps overlapping allocators (Asahi Lina)
- drm/asahi: fw.channels: Fix DestroyContext layout for V13_3 (Asahi Lina)
- drm/asahi: render: Add vertex register list for G14X (Asahi Lina)
- drm/asahi: render: Add fragment register list for G14X (Asahi Lina)
- drm/asahi: object: Implement From<Gpu[Weak]Pointer> for u64 (Asahi Lina)
- drm/asahi: fw.job: Add a helper constructor to make register lists (Asahi Lina)
- drm/asahi: object: Add a gpu_ptr argument new_prealloc raw fn (Asahi Lina)
- drm/asahi: fw.microseq: Implement and use WaitForIdle2 command (Asahi Lina)
- drm/asahi: fw,render: Render command structure updates for G14X (Asahi Lina)
- drm/asahi: buffer,workqueue: Update some conditionals for G14X (Asahi Lina)
- drm/asahi: render: Add missing unk1 field to StartFragment (Asahi Lina)
- drm/asahi: render,compute: Allocate command buffers from gpuro (Asahi Lina)
- gpu: Add a FW-RW/GPU-RO allocator (Asahi Lina)
- iommu/io-pgtable: Hack in FW-RW/GPU-RO mode into UAT io_pgtable (Asahi Lina)
- drm/asahi: fw.workqueue: Barrier update for G14X (Asahi Lina)
- drm/asahi: fw.channels: Message length & ID updates for G14X (Asahi Lina)
- drm/asahi: buffer: Scene update for G14X (Asahi Lina)
- drm/asahi: gpu,mmu: Map kernel AS to user contexts on G14X+ (Asahi Lina)
- drm/asahi: gpu: Move the buffer manager control to the kernel lower VM (Asahi Lina)
- drm/asahi: gpu: Implement SGX SRAM mapping (Asahi Lina)
- drm/asahi: initdata: Pad voltages out like macOS does (Asahi Lina)
- drm/asahi: initdata: Value updates for 13.3 (Asahi Lina)
- drm/asahi: initdata: Add version IDs for G14/G14X 13.3 (Asahi Lina)
- drm/asahi: driver: Bind to t6020 and t6021 (Asahi Lina)
- drm/asahi: hw: Add t602x device data (Asahi Lina)
- drm/asahi: regs: Implement ID and fault register changes for G14X (Asahi Lina)
- drm/asahi: Instantiate driver for 13.3 versions (Asahi Lina)
- drm/asahi: Load and set CS/AFR performance and leakage data (Asahi Lina)
- drm/asahi: fw.types: Impl Zeroed for F32 (Asahi Lina)
- rust: macros: versions: Support conditionals on block statements (Asahi Lina)
- drm/asahi: initdata: Implement new cfg/dyncfg dependent fields (Asahi Lina)
- drm/asahi: initdata: Pull shared3 table from the HwConfig (Asahi Lina)
- drm/asahi: Implement correct shared2 table calculation (Asahi Lina)
- drm/asahi: hw: Add new config fields for t8112/t602x (Asahi Lina)
- drm/asahi: Initdata structure updates for G14X/V13_3 (Asahi Lina)
- rust: macros: versions: Add V13_3 and G14X (Asahi Lina)
- drm/asahi: Drop 13.2 top-level support (Asahi Lina)
- drm/asahi: Make stats structs opaque (Asahi Lina)
- drm/asahi: Identify more Render fields & update to UAPI 10007 (Asahi Lina)
- I don't know how to fix drm_sched. (Asahi Lina)
- drm/asahi: Fail params requests if the GPU is crashed (Asahi Lina)
- drm/asahi: workqueue: Hold a Buffer reference in GpuContextData (Asahi Lina)
- drm/asahi: queue: Drop redundant mutex around Buffer (Asahi Lina)
- drm/asahi: Also free unused GPU contexts asynchronously (Asahi Lina)
- drm/asahi: Drop completed work asynchronously (Asahi Lina)
- drm/asahi: workqueue: Keep a Device reference here too (Asahi Lina)
- drm/asahi: workqueue: Panic on context inval timeouts if requested (Asahi Lina)
- drm/scheduler: Fix UAF in drm_sched_fence_get_timeline_name (Asahi Lina)
- rust: Fix container_of!() (Asahi Lina)
- drm/asahi: Move to uapi crate (Asahi Lina)
- drm/asahi: Make multi-page TLB invals use the CPU page size. (Asahi Lina)
- arm64: dts: apple: Add T602x GPU node (Asahi Lina)
- drm/asahi: Identify and set barrier_type field (Asahi Lina)
- drm/asahi: Align GEM object sizes to the UAT page size (Asahi Lina)
- drm/asahi: Add a flag to panic (oops) on GPU crashes (Asahi Lina)
- drm/asahi: Identify no_preemption flag (Asahi Lina)
- drm/asahi: Fix compute stats size (maybe) (Asahi Lina)
- drm/asahi: Track event sequences properly (Asahi Lina)
- drm/asahi: Identify vertex attachment list (Asahi Lina)
- drm/asahi: Add missing timeline syncobj signaling support (Asahi Lina)
- drm/asahi: Clippy cleanups (Asahi Lina)
- drm/asahi: channel: Increase timeouts, add sleeping mode (Asahi Lina)
- rust: module_param: Tolerate a trailing newline when parsing (Asahi Lina)
- drm/asahi: alloc: Make corruption ranges end-inclusive (Asahi Lina)
- drm/asahi: Remove padding from Vertex commands, move to 13_0B4+ (Asahi Lina)
- drm/asahi: Promote two fields in vert/frag structs to all versions (Asahi Lina)
- drm/asahi: Move GPU context drop inside refcount (Asahi Lina)
- drm/scheduler: Clean up jobs when the scheduler is torn down. (Asahi Lina)
- rust: helpers: Fix spinlock helper for various spinlock modes (Hector Martin)
- rust: Fix bindgen on arm64 (Hector Martin)
- drm/asahi: render: Always flush stamps on both vertex & frag (Asahi Lina)
- drm/asahi: queue: Add more debugging IDs (Asahi Lina)
...
- drm/asahi: Add the Asahi driver UAPI (Asahi Lina)
- rust: drm: gem: Add set_exportable() method (Asahi Lina)
- drm/gem: Add a flag to control whether objects can be exported (Asahi Lina)
- rust: drm: sched: Add GPU scheduler abstraction (Asahi Lina)
- drm/sched: Add can_run_job callback (Asahi Lina)
...
- drm/gem-shmem: Export VM ops functions (Asahi Lina)
- rust: drm: gem: Add GEM object abstraction (Asahi Lina)
- rust: drm: file: Add File abstraction (Asahi Lina)
- rust: drm: Add Device and Driver abstractions (Asahi Lina)
- rust: drm: ioctl: Add DRM ioctl abstraction (Asahi Lina)
- rust: io_pgtable: Add the Apple UAT format abstraction (Asahi Lina)
- iommu/io-pgtable: Add Apple UAT variant format (Asahi Lina)
- *RFL import: kernel::error::Error Debug impl & dependencies (Asahi Lina)
- *RFL import: kernel::KParamGuard & friends (Asahi Lina)
- rust: Allow feature allocator_api (Asahi Lina)
- rust: bindings: Add resource_size wrapper (Asahi Lina)
- *RFL import: Rest of kernel::error::code::* (Asahi Lina)
- *RFL import: macros::module params functionality & deps (Asahi Lina)
- rust: Add ioremap_np support to io_mem & friends (Asahi Lina)
- rust: kernel: platform: Add Device.set_dma_masks() (Asahi Lina)
- rust: platform: add `ioremap_resource` and `get_resource` methods (Maciej Falkowski)
- rust: driver,of: Support passing ID tables to modpost for alias generation (Asahi Lina)
- rust: of: Add OF node abstraction (Asahi Lina)
- *RFL import: kernel::delay (Asahi Lina)
- *RFL import: kernel::platform (Asahi Lina)
- *RFL import: kernel::of (Asahi Lina)
- *RFL import: kernel::io_mem (Asahi Lina)
- *RFL import: The rest of kernel::device (minus clk stuff) (Asahi Lina)
- *RFL import: kernel::driver (Asahi Lina)
- rust: Add `name` argument to Module::init() (Asahi Lina)
- rust: upgrade to Rust 1.66.0 (Miguel Ojeda)
- *RFL import: kernel::module_param (Asahi Lina)
- rust: Enable const_mut_refs feature for the kernel crate (Asahi Lina)
- MISSING SIGNOFFS: rust: Add PAGE_SIZE constant to kernel crate (Asahi Lina)
- *RFL import: kernel::user_ptr (Asahi Lina)
- *RFL import: kernel::io_buffer (Asahi Lina)
- *RFL import: kernel::types::Bool (Asahi Lina)
- rust: Add `container_of` and `offset_of` macros (Wedson Almeida Filho)
- rust: soc: apple: rtkit: Add Apple RTKit abstraction (Asahi Lina)
- rust: io_pgtable: Add io_pgtable abstraction (Asahi Lina)
- rust: device: Add an abstraction for devices (Wedson Almeida Filho)
- rust: Add a Sealed trait (Asahi Lina)
- rust: xarray: Add an abstraction for XArray (Asahi Lina)
- rust: time: New module for timekeeping functions (Asahi Lina)
- arm64: rust: Disable neon and fp target features. (Jamie Cunliffe)
- arm64: rust: Enable PAC support for Rust. (Jamie Cunliffe)
- arm64: rust: Enable Rust support for AArch64 (Miguel Ojeda)
- rust: ioctl: Add ioctl number manipulation functions (Asahi Lina)
- rust: uapi: Add UAPI crate (Asahi Lina)
- rust: sync: introduce `CondVar` (Wedson Almeida Filho)
- rust: lock: add `Guard::do_unlocked` (Wedson Almeida Filho)
- rust: sync: introduce `LockedBy` (Wedson Almeida Filho)
- rust: introduce `current` (Wedson Almeida Filho)
- rust: add basic `Task` (Wedson Almeida Filho)
- rust: introduce `ARef` (Wedson Almeida Filho)
- rust: lock: introduce `SpinLock` (Wedson Almeida Filho)
- rust: lock: introduce `Mutex` (Wedson Almeida Filho)
- rust: sync: introduce `Lock` and `Guard` (Wedson Almeida Filho)
- rust: sync: introduce `LockClassKey` (Wedson Almeida Filho)
- MAINTAINERS: add Benno Lossin as Rust reviewer (Miguel Ojeda)
- rust: init: broaden the blanket impl of `Init` (Benno Lossin)
- rust: sync: add functions for initializing `UniqueArc<MaybeUninit<T>>` (Benno Lossin)
- rust: sync: reduce stack usage of `UniqueArc::try_new_uninit` (Benno Lossin)
- rust: types: add `Opaque::ffi_init` (Benno Lossin)
- rust: prelude: add `pin-init` API items to prelude (Benno Lossin)
- rust: init: add `Zeroable` trait and `init::zeroed` function (Benno Lossin)
- rust: init: add `stack_pin_init!` macro (Benno Lossin)
- rust: init: add `PinnedDrop` trait and macros (Benno Lossin)
- rust: init/sync: add `InPlaceInit` trait to pin-initialize smart pointers (Benno Lossin)
- rust: init: add initialization macros (Benno Lossin)
- rust: add pin-init API core (Benno Lossin)
- rust: types: add `Opaque::raw_get` (Benno Lossin)
- rust: sync: change error type of constructor functions (Benno Lossin)
- rust: macros: add `quote!` macro (Gary Guo)
- rust: enable the `pin_macro` feature (Benno Lossin)
- rust: error: Add from_result() helper (Wedson Almeida Filho)
- rust: error: Add a helper to convert a C ERR_PTR to a `Result` (Sven Van Asbroeck)
- rust: error: Add to_result() helper (Wedson Almeida Filho)
- rust: error: Add Error::from_errno{_unchecked}() (Miguel Ojeda)
- rust: error: Add Error::to_ptr() (Asahi Lina)
- rust: error: Rename to_kernel_errno() -> to_errno() (Asahi Lina)
- rust: sync: arc: Add UniqueArc<MaybeUninit<T>::assume_init() (Asahi Lina)
- rust: sync: arc: Implement Arc<dyn Any + Send + Sync>::downcast() (Asahi Lina)
- rust: macros: Allow specifying multiple module aliases (Asahi Lina)
- rust: alloc: vec: Add some try_* methods we need (Miguel Ojeda)
- rust: Add SPDX headers to alloc::vec::{spec_extend, set_len_on_drop} (Asahi Lina)
- rust: Import upstream `alloc::vec::spec_extend` module (Asahi Lina)
- rust: Import upstream `alloc::vec::set_len_on_drop` module (Asahi Lina)
- rust: Enable the new_uninit feature for kernel and driver crates (Asahi Lina)
- samples: rust: print: Add sample code for Arc printing (Boqun Feng)
- rust: sync: impl {Debug,Display} for {Unique,}Arc (Boqun Feng)
...
- watchdog: apple: Support suspend and resume (Janne Grunau)
- squash! arm64: dts: apple: t8112: Remove always-on from the PMP node (Janne Grunau)
- PCI: apple: Log the time it takes for links to come up (Hector Martin)
- PCI: apple: Reorder & improve link-up logic (Hector Martin)
- HACK: Lol libwebrtc (Hector Martin)
...
- rust: Fixes for 1.67.0 (Hector Martin)
- init/Kconfig: Only block on RANDSTRUCT for RUST (Neal Gompa)
...
- fixup! cpuidle: apple: Add Apple SoC cpuidle driver (Hector Martin)
...
- drm/probe_helper: fix the warning reported when calling drm_kms_helper_poll_disable during suspend (Zongmin Zhou)
...
- arm64: dts: apple: t8103: Add the NVRAM bindings (Sasha Finkelstein)
- arm64: dts: apple: t8112: Add the NVRAM bindings (Sasha Finkelstein)
- arm64: dts: apple: t600x: Add the NVRAM bindings (Sasha Finkelstein)
...
- arm64: dts: apple: t8103: Fix spi4 power domain sort order (Hector Martin)
- arm64: dts: apple: Add backlight node to j314/j316 (Hector Martin)
...
- arm64: dts: apple: t600x: Add spi3 node (Janne Grunau)
- arm64: dts: apple: t600x-j314-j316: Add NOR flash node (Hector Martin)
- arm64: dts: apple: t6000: Add spi1 node (Hector Martin)
...
- arm64: dts: apple: Add backlight node to j293/j313 (Thomas Glanzmann)
...
- arm64: dts: apple: Add PCI power enable GPIOs (Hector Martin)
- arm64: dts: apple: t8103: Add spi3/keyboard nodes (Janne Grunau)
- arm64: dts: apple: t8103: Add dwc3 nodes (Hector Martin)
- arm64: dts: apple: t8112: Add mtp device nodes for j413/j493 (Janne Grunau)
- arm64: dts: apple: Add backlight node to j413/j493 (Thomas Glanzmann)
...
- arm64: dts: apple: t8112-j493: Add spi3 node (Janne Grunau)
- arm64: dts: apple: t8112: Add PMU NVMEM and SMC RTC/reboot nodes (Hector Martin)
...
- dt-bindings: dma: apple,admac: Add t8112-admac compatible (Janne Grunau)
...
- gpu: drm: apple: Use drm_aperture_remove_conflicting_framebuffers (Janne Grunau)
...
- gpu: drm: apple: Update date last update (Janne Grunau)
...
- nvmem: round up to word_size (Sven Peter)
- nvmem: allow bit offset > 8 (Sven Peter)
- pwm: Add Apple PWM controller (Sasha Finkelstein)
- xhci-pci: asmedia: Add a firmware loader for ASM2214a chips (Hector Martin)
- usb: renesas-xhci: Build loader into the main xhci-pci module (Hector Martin)
- PCIE: apple: Add T602x PCIe support (Hector Martin)
...
- PCI: apple: Initialize pcie->nvecs before using it (Sven Peter)
- PCI: apple: Set only available ports up (Janne Grunau)
- PCI: apple: Fix missing OF node reference in apple_pcie_setup_port (Hector Martin)
...
- PCI: apple: Use gpiod_set_value_cansleep in probe flow (Hector Martin)
- dt-bindings: pci: apple,pcie: Add subnode binding, pwren-gpios property (Hector Martin)
- nvmem: Add spmi-mfd-nvmem driver (Hector Martin)
- mfd: Add a simple-mfd-spmi driver (Hector Martin)
- spmi: add a first basic spmi driver for Apple SoC (Jean-Francois Bortolotti)
...
- soc: apple: rtkit: Get rid of apple_rtkit_send_message_wait (Hector Martin)
...
- wifi: brcmfmac: Demote vendor-specific attach/detach messages to info (Hector Martin)
- brcmfmac: Shut up p2p unknown frame error (Hector Martin)
...
- brcmfmac: pcie: Add BCM4378B3 support (Hector Martin)
- brcmfmac: common: Add support for external calibration blobs (Hector Martin)
- brcmfmac: pcie: Load and provide TxCap blobs (Hector Martin)
- brcmfmac: common: Add support for downloading TxCap blobs (Hector Martin)
- brcmflac: cfg80211: Use WSEC to set SAE password (Hector Martin)
- brcmfmac: cfg80211: Add support for PMKID_V3 operations (Hector Martin)
- brcmfmac: feature: Add support for setting feats based on WLC version (Hector Martin)
- brcmfmac: cfg80211: Add support for scan params v2 (Hector Martin)
- brcmfmac: chip: Handle 1024-unit sizes for TCM blocks (Hector Martin)
- brcmfmac: chip: Only disable D11 cores; handle an arbitrary number (Hector Martin)
- brcmfmac: acpi: Add support for fetching Apple ACPI properties (Hector Martin)
- ACPI / property: Support strings in Apple _DSM props (Hector Martin)
...
- ASoC: cs42l84: Do not enable the PLL before the clocks are ready (Hector Martin)
...
- ASoC: cs42l84: Report volume updates correctly (Hector Martin)
- ASoC: cs42l84: Enable regcache (initially) (Martin Povišer)
- ASoC: macaudio: Improve message on opening of unrouted PCM devices (Martin Povišer)
- ASoC: apple: mca: Constrain channels according to TDM mask (Martin Povišer)
- ASoC: cs42l84: Put the volume control in shape (Martin Povišer)
- ASoC: cs42l84: Adjust mic-detection voltage threshold (Martin Povišer)
- ASoC: cs42l84: There's no line-in on the jack (Martin Povišer)
...
- wip: ASoC: cs42l84: Start new codec driver (Martin Povišer)
- dt-bindings: sound: Add CS42L84 codec (Martin Povišer)
...
- ASoC: tas2764: Add control concerning overcurrent events (Martin Povišer)
- ASoC: tas2764: Extend driver to SN012776 (Martin Povišer)
- Revert "ASoC: ops: Don't modify the driver's plaform_max when reading state" (Martin Povišer)
- spi: apple: Add driver for Apple SPI controller (Hector Martin)
- dt-bindings: spi: apple,spi: Add binding for Apple SPI controllers (Hector Martin)
- apple-nvme: Support coprocessors left idle (Hector Martin)
...
- i2c: pasemi: Enable the unjam machine (Hector Martin)
- of: HACK: disable backlight supplier binding if not needed (Hector Martin)
...
- drm/simpledrm: Make backlight support a Kconfig option (Hector Martin)
- PCI: apple: Add depends on ARM64_PAGE_SHIFT = 14 (Janne Grunau)
- drivers/perf: Add Apple blizzard/avalanche to Apple M1 CPU PMU driver (Janne Grunau)
...
- drm/simpledrm: Add backlight support (Hector Martin)
...
- HACK: iommu: apple-dart: workaround broken runtime PM with PCIe devices (Janne Grunau)
- iommu: apple-dart: Don't attempt to reset/restore locked DARTs (Hector Martin)
- iommu: apple-dart: Install IOMMU_RESV_TRANSLATED mappings (Janne Grunau)
- iommu: io-pgtable: Add locked DART quirk (Alyssa Rosenzweig)
- iommu/dart: Assert !locked when reconfiguring (Alyssa Rosenzweig)
- iommu/dart: Require DMA domain for locked DARTs (Alyssa Rosenzweig)
- iommu/dart: Set DMA domain for locked DARTs (Alyssa Rosenzweig)
- iommu/dart: Factor out apple_dart* expression (Alyssa Rosenzweig)
- iommu/dart: Allow locked DARTs to probe (Alyssa Rosenzweig)
...
- iommu/io-pgtable: dart: Remove unused __dart_alloc_pages() paramater (Janne Grunau)
...
- soc: apple: rtkit: Crop syslog messages (Martin Povišer)
- soc: apple: Drop !APPLE_MAILBOX dependency (Hector Martin)
- mailbox: apple: Delete driver (Hector Martin)
- soc: apple: rtkit: Port to the internal mailbox driver (Hector Martin)
- soc: apple: mailbox: Add ASC/M3 mailbox driver (Hector Martin)
- soc: apple: rtkit: Add APPLE_RTKIT_PWR_STATE_INIT (Janne Grunau)
- soc: apple: rtkit: Log failed buffer requests (Asahi Lina)
- soc: apple: rtkit: Fix buffer address field width (Asahi Lina)
- soc: apple: rtkit: Log failure to send messages (Asahi Lina)
- soc: apple: rtkit: Check for failure to send mgmt messages & log (Asahi Lina)
- MAINTAINERS: Add entries for Apple PWM driver (Sasha Finkelstein)
- MAINTAINERS: Add apple-spi driver & binding files (Hector Martin)
- MAINTAINERS: Add Apple dwc3 bindings to ARM/APPLE (Hector Martin)
- dt-bindings: pwm: Add Apple PWM controller (Sasha Finkelstein)
- arm64: dts: apple: t8112: Add PWM controller (Sasha Finkelstein)
- arm64: dts: apple: t600x: Add PWM controller (Sasha Finkelstein)
- arm64: dts: apple: t8103: Add PWM controller (Sasha Finkelstein)
- arm64: dts: apple: t600x: Disable unused PCIe ports (Janne Grunau)
- arm64: dts: apple: t8112: Initial t8112 (M2) device trees (Hector Martin)
- dt-bindings: arm: apple: Add t8112 j413/j473/j493 compatibles (Janne Grunau)
- dt-bindings: clock: apple,nco: Add t8112-nco compatible (Janne Grunau)
- dt-bindings: i2c: apple,i2c: Add apple,t8112-i2c compatible (Janne Grunau)
- dt-bindings: pinctrl: apple,pinctrl: Add apple,t8112-pinctrl compatible (Janne Grunau)
- dt-bindings: pci: apple,pcie: Add t8112 support (Janne Grunau)
- dt-bindings: nvme: apple: Add apple,t8112-nvme-ans2 compatible string (Janne Grunau)
- dt-bindings: mailbox: apple,mailbox: Add t8112 compatibles (Janne Grunau)
- dt-bindings: iommu: apple,sart: Add apple,t8112-sart compatible string (Janne Grunau)
- dt-bindings: interrupt-controller: apple,aic2: Add apple,t8112-aic compatible (Janne Grunau)
- dt-bindings: arm: cpus: Add apple,avalanche & blizzard compatibles (Janne Grunau)
- dt-bindings: watchdog: apple,wdt: Add t8112-wdt compatible (Janne Grunau)
- dt-bindings: arm: apple: apple,pmgr: Add t8112-pmgr compatible (Janne Grunau)
- dt-bindings: power: apple,pmgr-pwrstate: Add t8112 compatible (Hector Martin)
